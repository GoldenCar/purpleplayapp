<template>
    ...
    <div style="background: #000;">
        ...
        <div id="playerTransport" class="row" style="position: relative;">
            <q-btn id="chapterMenuButton" v-if="chapters && chapters.length && chapters.length > 1" flat size="lg" class="col bg-grey-4 transportButton" @click="openModal = true, $emit('togglePlay', true)">
